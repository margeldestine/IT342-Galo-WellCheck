...
public class AuthService {
    ...
    public String registerStudent(StudentRegisterRequest request) {
        ...
        studentProfile.setStudentIdNumber(request.getStudentIdNumber());
        studentProfile.setProgram(request.getProgram());
        studentProfile.setYearLevel(request.getYearLevel());
        studentProfile.setGender(request.getGender());
        studentProfile.setBirthdate(request.getBirthdate());
